          ...
          <div id={style.UpWrapper}>
            <div id={style.leftWrapper}>
              ...
              <textarea
                onChange={Material}
                ref={materialRef}
                placeholder="ex)깨진 유리조각, 페트병, 가죽치마 (100자 이내)"
            ...
            <div id={style.rightWrapper}>
              <div id={style.tipbox1}>
                ...
                <p className={style.tipcontent}>
                  업사이클링 상품만의 장점을 잘 드러나는 키워드를 한 가지 이상
                  포함해 주세요.
                </p>
                <p className={style.tipcontent}>
                  중요한 키워드는 눈에 잘 띄도록 제목 앞부분에 적는 것을
                  추천해요.
                </p>
              </div>
              <div id={style.tipbox2}>
                ...
                <p className={style.tipcontent}>
                  제품의 첫인상인 대표 이미지는 가장 매력적으로 보이는 사진을
                  선택해 주세요.
                </p>
                <p className={style.tipcontent}>
              ...
              <div id={style.tipbox4}>
                <p className={style.tiptitle}>
                  TIP! 업사이클한 자재에 대한 자세한 설명
                </p>
                <p className={style.tipcontent}>
                  어떤 자재를 가지고 만들었는지 적어주세요. 자세할수록 소비자의
                  마음을 사로잡기 좋습니다. 추후 수정이 불가하니 신중하게
                  적어주세요.
                </p>
              </div>
              <div id={style.tipbox5}>
                <p className={style.tiptitle}>
                  TIP! 가격은 너무 낮거나 높지 않게
                </p>
                <p className={style.tipcontent}>
