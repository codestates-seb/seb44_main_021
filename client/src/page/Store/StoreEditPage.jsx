            ...
            <div id={style.AllWrapper}>
                ...
                <div id={style.rightWrapper}>
                    ...
                    <div className={style.AmountBox}>
                        <div className={style.text1}>카테고리는 <p className={style.text2}>{data.sellCategoryName}</p>로 선택하셨습니다. </div>
                        <div className={style.text1}>가격은 <p className={style.text2}>{data.price}</p>원으로 선택하셨습니다.</div>
                    </div>
