...
public interface UpcyclingRepository extends JpaRepository<Upcycling, Long> {
    ...
    // 업사이클러 게시글 검색 기능
    Page<Upcycling> findByTitleContaining(String searchKeyword, Pageable pageable);
    ...
    // 업사이클러 게시글 검색 기능 + 카테고리
    Page<Upcycling> findByTitleContainingAndCategory(String searchKeyword, Category category, Pageable pageable);
}
